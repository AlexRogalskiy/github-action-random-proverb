...
LABEL repository="https://github.com/AlexRogalskiy/github-action-random-proverb"
LABEL homepage="https://github.com/AlexRogalskiy/github-action-random-proverb"
